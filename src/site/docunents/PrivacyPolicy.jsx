    ...
    return (
        <>
            ...
            <div style={{fontFamily: 'Montserrat, serif', fontWeight: 400, fontSize: '14px', color: '#242A37', width: '700px', marginLeft: 'calc(50% - 350px)'}}>
                ...
                <p style={{margin: '0'}}>
                    Ваші дані зберігаються на моїй базі даних. Дані зберігаються до тих пір, поки ви не запросите їх видалення, зв'язавшись зi мною за офіційною адресою: tstmlfrprjcts@gmail.com.
                </p>
                <p style={{fontWeight: 500,fontSize: '16px', margin: '10px 0 0'}}>           
                    Зв'язок зi мною:
                </p>
