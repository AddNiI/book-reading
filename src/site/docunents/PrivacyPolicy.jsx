    ...
    return (
        <>
            ...
            <div style={{fontFamily: 'Montserrat, serif', fontWeight: 400, fontSize: '14px', color: '#242A37', width: '700px', marginLeft: 'calc(50% - 350px)'}}>
                ...
                <Link to="/login">
                    <button style={{marginTop: '20px', color: '#fff', backgroundColor: '#FF6B08', border: '0', fontFamily: '"Montserrat", serif', fontWeight: 500, fontSize: '14px', padding: '11px 42px', cursor: 'pointer'}}>Повернутися на головну сторiнку</button>
                </Link>
            </div>
        </>
    )
