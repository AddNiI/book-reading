    ...
    return (
        <>
            ...
            <main style={{fontFamily: 'Montserrat, serif', fontWeight: 400, fontSize: '14px', color: '#242A37', width: '80vw', marginLeft: '15vw'}}>
                ...
                <p style={{margin: '0'}}>
                    1. Ваше ім'я використовується для відображення вгорі сторінки в роздiлах "бiблiотека" та "тренування", та на сторiнцi користувача.<br />
                    ...
                    3. Ваш аватар використовується для відображення вгорі сторінки в роздiлах "бiблiотека" та "тренування", та на сторiнцi користувача.<br />
                    4. Ці дані використовуються виключно для функціонування цього інтернет сайту і не використовуються для інших цілей. Цi даннi можно змiнити на сторiнцi користувача.
                </p>
                <p style={{fontWeight: 500,fontSize: '16px', margin: '10px 0 0'}}>
                ...
                <p style={{margin: '0'}}>
                    Ваші дані зберігаються на моїй базі даних. Дані зберігаються до тих пір, поки ви не видалете iх на сторiнцi користувача.
                </p>
                <p style={{fontWeight: 500,fontSize: '16px', margin: '10px 0 0'}}>           
                    Зв'язок зi мною:
                </p>
